...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/login/userLogin.css">
    <link rel="stylesheet" href="../css/style.css">
</head>
<body class="stop-scrolling">
<div class="grid">
    <div class="grid-1">
        <div class="grid-1__login">
            <div class="grid-1__login__bar page2">
                <a class="grid-1__login__bar-logo" href="index.html">
                    <svg
            ...
            >
            <span class="personal_impormation"
            >내용을 확인하였고 동의합니다.</span
            >
        </div>
    </div>
    <div class="pencil">
        <img src="https://class101.net/images/login/login-bg.png"/>
    </div>
</div>
</body>
</html>