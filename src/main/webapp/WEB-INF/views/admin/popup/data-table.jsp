                                    ...
                                    <c:forEach var="i" begin = "1" end = "${popupList.size()}">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-primary" onclick="location.href='/admin/popup/edit?popNo=${popupList[i-1].popNo}'">수정</button>
                                                <button class="btn btn-secondary" onclick="if(confirm('정말 삭제하시겠습니까?')){location.href='/admin/popup/delete?popNo=${popupList[i-1].popNo}';} else {return false;}">삭제</button>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
